...
const HeroSection = () => {
  return (
    <section id="home" className="w-full min-h-screen flex items-center justify-center bg-background py-24">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="font-headline text-4xl md:text-6xl font-bold tracking-tighter">Phillip Otieno</h1>
