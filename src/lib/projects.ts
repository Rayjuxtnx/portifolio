...
export const projects = [
    {
      ...
      image: "https://images.unsplash.com/photo-1455165814004-1126a7199f9b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHx3ZWxkaW5nfGVufDB8fHx8MTc2MzQ5NDY0N3ww&ixlib=rb-4.1.0&q=80&w=1080",
      imageHint: "welding",
    ...
    },
    {
      ...
      tools: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Mapbox", "Vercel"],
      results: "Delivered a high-performance tracking dashboard capable of handling real-time data streams for multiple drones simultaneously. The intuitive UI improved operator efficiency by 25%.",
      image: "https://images.unsplash.com/photo-1508444845599-5c89863b1c44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxkcm9uZSUyMHRyYWNraW5nfGVufDB8fHx8MTc2MzQ5NTEzMnww&ixlib=rb-4.1.0&q=80&w=1080",
      imageHint: "drone tracking",
      tags: ["Web Developer"],
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxyZXN0YXVyYW50J2IwZm9vZHxlbnwwfHx8fDE3NTY3NDc1NjR8MA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      description: "Developed a conversational AI virtual assistant capable of answering questions and providing information based on a given context. The assistant is integrated into a web application, providing a seamless and interactive user experience.",
      tools: ["Python", "Java", "Next.js", "React", "TypeScript", "Tailwind CSS", "Zod"],
      results: "Successfully deployed a functional AI assistant that can handle user queries, improving user engagement. The assistant is designed to be easily adaptable to different knowledge bases.",
      image: "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxBSSUyMHN5c3RlbXxlbnwwfHx8fDE3NTgwMjA4MTB8MA&ixlib-rb-4.1.0&q=80&w=1080",
      imageHint: "AI code",
