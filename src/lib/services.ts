...
export const services: Record<string, Service> = {
  ...
  "wifi-billing-system": {
    ...
    icon: Wifi,
    description: "Automated billing and management for WiFi hotspot providers, including voucher generation and payment integration.",
    details: "I develop comprehensive WiFi billing systems that automate user management, voucher creation, and payment processing. Ideal for businesses offering public or private WiFi access, this system simplifies operations and enhances user experience.",
    packages: [
      {
        title: "🟢 Basic Hotspot Package",
        price: "Ksh 50,000 – 100,000",
        bestFor: "Small cafes, restaurants, or guest houses.",
        includes: [
          "User authentication portal (splash page)",
          "Voucher generation & management (time/data limited)",
          "Integration with one payment gateway (e.g., MPesa)",
          "Admin dashboard for user & voucher tracking",
          "Basic reporting (usage, sales)",
          "Setup with compatible routers (MikroTik, Ubiquiti)",
          "On-site setup assistance (within select areas)",
        ],
      },
      {
        title: "🟡 Standard Hotspot Package",
        price: "Ksh 120,000 – 250,000",
        bestFor: "Hotels, apartments, or medium-sized public spaces.",
        includes: [
          "Everything in Basic, plus:",
          "Multi-router management",
          "Subscription plans (daily, weekly, monthly)",
          "Automated invoicing & billing",
          "Advanced user management (bandwidth control, session limits)",
          "Customer portal for account management",
          "Integration with multiple payment gateways",
          "Branded splash pages and user portals",
        ],
      },
      {
        title: "🔵 Premium Hotspot Package",
        price: "Ksh 300,000+",
        bestFor: "ISPs, large-scale public WiFi (e.g., malls, transport), or enterprise clients.",
        includes: [
          "Everything in Standard, plus:",
          "Full multi-tenant ISP billing system",
          "RADIUS server integration",
          "Advanced analytics and business intelligence dashboard",
          "Integration with accounting software (e.g., QuickBooks)",
          "SMS notifications for payments and expiry",
          "High-availability and failover setup",
          "Comprehensive API for third-party integrations",
          "Long-term support and maintenance contract",
        ],
      },
    ],
  },
