    ...
    packages: [
      {
        ...
        bestFor: "small shops, cyber cafés, or small estates (≤ 20 users)",
        includes: [
      ...
      {
        title: "🔵 Standard Package",
        price: "KSh 300,000 – 500,000",
        bestFor: "estates, hotels, schools, or shared offices (20–100 users)",
        includes: [
          "Everything in Basic, plus:",
      ...
      },
      {
        ...
        bestFor: "ISPs, large networks, universities, apartments (100–1000+ users)",
        includes: [
     ...
     addOns: [
        { title: "SMS confirmation", price: "+KSh 10,000" },
        { title: "Branding & logo design", price: "+KSh 5,000" },
        { title: "Android admin app", price: "+KSh 60,000" },
        { title: "Logo animation & branding video", price: "+KSh 10,000" },
        { title: "Mobile app for users", price: "+KSh 100,000 – 180,000" },
        { title: "AI-based usage prediction", price: "+KSh 70,000 – 150,000" },
    ],
  },
  "digital-marketing": {
